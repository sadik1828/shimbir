        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          >
            <Link to="/" className="flex items-center space-x-2 mb-6">
              ...
              <span className="text-xl font-bold text-white">Shimbir Group</span>
            </Link>
            <p className="text-gray-400 mb-6 leading-relaxed">
              Professional construction services delivering quality, reliability, and excellence since 2010. Building Somalia's future, one project at a time.
            </p>
          ...
          >
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                <svg className="w-5 h-5 mr-3 mt-1 text-[#dd6b20]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <li className="flex items-start">
                ...
                <span>+252 61 555 0123</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 mr-3 mt-1 text-[#dd6b20]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span>info@shimbirgroup.com</span>
              </li>
              <li className="flex items-start">
                <svg className="w-5 h-5 mr-3 mt-1 text-[#dd6b20]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
