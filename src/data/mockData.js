...
export const projects = [
  {
    ...
    images: [
      ...
      'https://images.unsplash.com/photo-1545569341-9eb8b6f9f2e0?w=800'
    ],
    beforeImages: [
  ...
  },
  {
    ...
    description: 'Complete renovation of 200,000 sq ft shopping center',
    location: 'Dallas, TX',
    category: 'Commercial Construction',
    tags: ['Renovation', 'Retail', 'Large Scale'],
  ...
  },
  {
    ...
    description: 'Complete build-out of upscale restaurant space',
    location: 'New York, NY',
    category: 'Commercial Construction',
    tags: ['Restaurant', 'Interior', 'Custom Build'],
    client: 'Gourmet Dining Group',
    budget: '$950K',
    duration: '4 months',
    images: [
      'https://images.unsplash.com/photo-1517270669776-4f04ad449351?w=800',
...
export const testimonials = [
  {
    ...
    content: 'Shimbir Group exceeded our expectations in every way. Their attention to detail and commitment to quality made our dream home a reality. The team was professional, responsive, and delivered on time.',
    rating: 5,
  ...
  },
  {
    ...
    content: 'Working with Shimbir Group on our office renovation was a seamless experience. They understood our vision and executed it perfectly. The workspace is now functional, beautiful, and exactly what we wanted.',
    rating: 5,
  ...
  },
  {
    ...
    content: 'Professional, reliable, and highly skilled. Shimbir Group delivered our commercial building project ahead of schedule and under budget. Their project management was exceptional throughout the entire process.',
    rating: 5,
...
export const teamMembers = [
  {
    ...
    bio: 'With over 20 years of experience in the construction industry, John founded Shimbir Group with a vision to deliver exceptional quality and customer satisfaction.',
    image: 'https://randomuser.me/api/portraits/men/32.jpg',
    social: {
      linkedin: '#',
      email: '#'
  ...
  },
  {
    ...
    bio: 'Sarah manages day-to-day operations and ensures smooth project execution from start to finish.',
...
export const blogPosts = [
  {
    ...
    content: 'The construction industry is evolving rapidly with new technologies and sustainable practices...',
    author: 'John Shimbir',
    date: '2026-01-15',
    image: 'https://images.unsplash.com/photo-1581091226033-d5c48150dbaa?w=800',
  ...
  },
  {
    ...
    content: 'Choosing the right contractor can make or break your construction project...',
    author: 'Emily Rodriguez',
    date: '2026-01-28',
    image: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=800',
    category: 'Tips & Advice',
    tags: ['Contractor', 'Tips', 'Planning']
  },
  {
    _id: '3',
    title: 'Sustainable Building Materials Guide',
    excerpt: 'Explore eco-friendly materials that reduce environmental impact.',
    content: 'Sustainable construction is no longer optional—it\'s essential for the future...',
    author: 'Michael Chen',
    date: '2026-02-05',
    image: 'https://images.unsplash.com/photo-1568605117036-5fe5e7bab0b7?w=800',
    category: 'Sustainability',
    tags: ['Green Building', 'Materials', 'Eco-Friendly']
  }
];
